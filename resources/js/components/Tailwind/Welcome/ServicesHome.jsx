...
const ServicesHome = ({ dataAbout, services, is_home = false }) => {
    ...
    // Si is_home es true, la sección usa h2; si es una página interna, usa h1
    const MainHeadingTag = is_home ? "h2" : "h1";
    // Las tarjetas de servicio descienden lógicamente del título principal
    const CardHeadingTag = is_home ? "h3" : "h2";
            ...
            <div className={`relative w-full px-[5%] 4xl:px-[8%] gap-10 xl:gap-16 flex flex-col items-center pb-2 ${is_home ? 'pt-10 xl:pt-20' : 'py-10 xl:py-20'} `}>
                ...
                {!!headsectionServices?.visible && (
                    <div className="w-full flex flex-col items-center justify-center gap-5 max-w-3xl 4xl:max-w-4xl text-center">
                        ...
                        <MainHeadingTag className="font-sora text-[#131e2e] text-3xl sm:text-4xl 2xl:text-5xl 4xl:text-6xl font-semibold tracking-tight !leading-tight">
                    ...
                    {services?.map((service) => (
                        <div key={service.id} className="service-card bg-white rounded-2xl border border-gray-100 shadow-md overflow-hidden flex flex-col">
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <CardHeadingTag className="font-sora text-[#324050] text-base sm:text-lg 2xl:text-xl 4xl:text-2xl font-semibold tracking-tight !leading-tight mb-3">
                                    {service.name}
                                </CardHeadingTag>
