      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="mt-4 font-sora text-black text-3xl sm:text-4xl 4xl:text-5xl font-semibold tracking-tight mb-4 !leading-tight max-w-2xl">
               {article.name}
            </h1>
          ...
          >
            {
              previousArticle
                ? <Tippy content={previousArticle.name}>
                  <a href={`/blog/${previousArticle.slug}`} className="text-amber-400 hover:text-amber-500 transition-colors duration-200 flex items-center">
